...
$$
BS_{j}^{\tau} = \frac{1}{\left| \mathcal{B}_{j, \tau} \right|} \sum_{i \in \mathcal{B}{j, \tau}} p_{j, i}
$$
...
$$
FS_{j}^{\tau} = \frac{1}{\left| \mathcal{F}_{j, \tau}\right|} \sum_{i \in \mathcal{F}{j, \tau}} p_{j, i}
$$
